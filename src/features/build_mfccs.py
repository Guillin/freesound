...
SAVE_PATH = '../../data/processed/mfcc/test_mfccs.npy'
...
def gen_mfcc(input_path=DATA_PATH, output_path=SAVE_PATH, hop_length = 512, max_pad_len=None):
...
gen_mfcc(DATA_PATH, SAVE_PATH, hop_length = 512, max_pad_len=200)
